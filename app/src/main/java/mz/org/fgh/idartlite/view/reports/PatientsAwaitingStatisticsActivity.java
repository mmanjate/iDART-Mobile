...
public class PatientsAwaitingStatisticsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dispenseStatisticReportBinding=   DataBindingUtil.setContentView(this, R.layout.activity_patients_awaiting_statistics);
        ...
        dispenseStatisticReportBinding.edtSearchParam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(PatientsAwaitingStatisticsActivity.this, new DatePickerDialog.OnDateSetListener() {
    ...
    public BaseViewModel initViewModel() {
        return new ViewModelProvider(this).get(AwatingPatientsStatisticReportVM.class);
    }

    @Override
    public AwatingPatientsStatisticReportVM getRelatedViewModel() {
        return (AwatingPatientsStatisticReportVM) super.getRelatedViewModel();
    }
