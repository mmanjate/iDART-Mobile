...
import mz.org.fgh.idartlite.databinding.ActivityPatientTreatmentFollowUpReportBinding;
import mz.org.fgh.idartlite.listener.recyclerView.IOnLoadMoreListener;
import mz.org.fgh.idartlite.model.ClinicInformation;
import mz.org.fgh.idartlite.util.DateUtilities;
import mz.org.fgh.idartlite.util.Utilities;
import mz.org.fgh.idartlite.viewmodel.report.PatientTreatmentFollowUpReportVM;

public class PatientTreatmentFollowUpReportActivity extends BaseActivity {

    private ActivityPatientTreatmentFollowUpReportBinding followUpReportBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent != null){
            ...
            if(bundle != null) {
                getRelatedViewModel().setReportType((String) bundle.getSerializable(ClinicInformation.PARAM_FOLLOW_STATUS));
            }
        }
        
        followUpReportBinding = DataBindingUtil.setContentView(this, R.layout.activity_patient_treatment_follow_up_report);

        reportRecycler = followUpReportBinding.reyclerPatient;



        followUpReportBinding.setViewModel(getRelatedViewModel());
        ...
        followUpReportBinding.edtStartDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(PatientTreatmentFollowUpReportActivity.this, new DatePickerDialog.OnDateSetListener() {

                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {

                        followUpReportBinding.edtStartDate.setText(dayOfMonth + "-" + (monthOfYear + 1) + "-" + year);
        ...
        followUpReportBinding.edtStartDate.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
        ...
        followUpReportBinding.edtEndDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int mYear, mMonth, mDay;
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(PatientTreatmentFollowUpReportActivity.this, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        ...
                        followUpReportBinding.edtEndDate.setText(dayOfMonth + "-" + (monthOfYear + 1) + "-" + year);
        ...
        followUpReportBinding.edtEndDate.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View view, boolean b) {
                if (b) {
                    int mYear, mMonth, mDay;
    ...
    @Override
    public PatientTreatmentFollowUpReportVM getRelatedViewModel() {
        return (PatientTreatmentFollowUpReportVM) super.getRelatedViewModel();
    }

    @Override
    public BaseViewModel initViewModel() {
        return new ViewModelProvider(this).get(PatientTreatmentFollowUpReportVM.class);
    }
    ...
    private void createPdf(List<ClinicInformation> clinicInformations) throws IOException, DocumentException {
        ...
        String pdfname = "Lista_monitoria_adesao"+ DateUtilities.formatToDDMMYYYY(new Date())+".pdf";
        ...
        for (ClinicInformation clinicInformation : clinicInformations){
            ...
            table.addCell(String.valueOf(clinicInformation.getLateDays()));
